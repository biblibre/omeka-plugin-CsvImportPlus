 ...
 * @package CsvImport
 */
class CsvImportPlus_ColumnMap_ExportedElementTest extends CsvImportPlus_Test_AppTestCase
{
    public function testConstructWithoutElementDelimiter()
    {
        ...
        $map = new CsvImportPlus_ColumnMap_ExportedElement($columnName);
        $this->assertInstanceOf('CsvImportPlus_ColumnMap_ExportedElement', $map);
        ...
        $elementDelimiter = '^^';
        $this->assertEquals($elementDelimiter, CsvImportPlus_ColumnMap_ExportedElement::DEFAULT_ELEMENT_DELIMITER);
    }
